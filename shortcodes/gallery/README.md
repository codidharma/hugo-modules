...
use this new version instead <https://github.com/codidharma/hugo-modules/tree/master/gallery-slider>
...
```toml
[[imports]]
path = "github.com/codidharma/hugo-modules/shortcodes/gallery"
```
